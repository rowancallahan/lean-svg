...
python3 tests/run_tests.py             # 24/28 (was 23/27; new 31_writing_mode.svg passes at 99.94%)
...
non-text or horizontal-text renders), plus the new `31_writing_mode.svg`
at 99.94% within-8.
...
* `tests/svg/31_writing_mode.svg` — new local regression test: `tb` and
