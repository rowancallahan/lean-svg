...
(import), `tests/svg/28_masks.svg` (new).
...
`theorems ok`; `tests/run_tests.py` scores unchanged for 01–27, 28_masks 99.993%
...
natural size and `--width 800`; `--threads 4` byte-identical on 28_masks;
