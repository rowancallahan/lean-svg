# R1-enable-background — resvg-wrong research: `enable-background` / BackgroundImage  (branch `claude/research-r1-enable-background`)
...
- `docs/resvg-wrong/R1-enable-background.md`: one section per file with the above, then a
  summary table (file, class, correct reference, one-line cause), then a
  "Questions for Rowan" list.
- `docs/resvg-wrong/R1-enable-background.png`: one comparison sheet, a row per file:
...
|---|---|---|
| `filters/enable-background/accumulate-with-new.svg` | pass 1.000000 | chrome=2 firefox=2 safari=2 |
| `filters/enable-background/accumulate.svg` | pass 1.000000 | chrome=2 firefox=2 safari=2 |
| `filters/enable-background/filter-on-shape.svg` | pass 1.000000 | chrome=2 firefox=2 safari=2 |
| `filters/enable-background/inherit.svg` | pass 1.000000 | chrome=2 firefox=2 safari=2 |
| `filters/enable-background/new-with-invalid-region-1.svg` | pass 1.000000 | chrome=2 firefox=2 safari=2 |
| `filters/enable-background/new-with-invalid-region-2.svg` | pass 1.000000 | chrome=2 firefox=2 safari=2 |
| `filters/enable-background/new-with-invalid-region-3.svg` | pass 1.000000 | chrome=2 firefox=2 safari=2 |
| `filters/enable-background/new-with-region.svg` | pass 1.000000 | chrome=2 firefox=2 safari=2 |
| `filters/enable-background/new.svg` | pass 1.000000 | chrome=2 firefox=2 safari=2 |
| `filters/enable-background/shapes-after-filter.svg` | pass 1.000000 | chrome=2 firefox=2 safari=2 |
| `filters/enable-background/stop-on-the-first-new-1.svg` | pass 1.000000 | chrome=2 firefox=2 safari=2 |
| `filters/enable-background/stop-on-the-first-new-2.svg` | pass 1.000000 | chrome=2 firefox=2 safari=2 |
| `filters/enable-background/with-clip-path.svg` | pass 1.000000 | chrome=2 firefox=2 safari=2 |
| `filters/enable-background/with-filter-on-the-same-element.svg` | pass 1.000000 | chrome=2 firefox=2 safari=2 |
| `filters/enable-background/with-filter.svg` | pass 1.000000 | chrome=2 firefox=2 safari=2 |
| `filters/enable-background/with-opacity-1.svg` | pass 1.000000 | chrome=2 firefox=2 safari=2 |
| `filters/enable-background/with-opacity-2.svg` | pass 1.000000 | chrome=2 firefox=2 safari=2 |
| `filters/enable-background/with-opacity-3.svg` | pass 1.000000 | chrome=2 firefox=2 safari=2 |
| `filters/enable-background/with-opacity-4.svg` | pass 1.000000 | chrome=2 firefox=2 safari=2 |
| `filters/enable-background/with-transform.svg` | pass 1.000000 | chrome=2 firefox=2 safari=2 |
