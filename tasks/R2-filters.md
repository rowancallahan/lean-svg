# R2-filters — resvg-wrong research: filter region/primitive cases  (branch `claude/research-r2-filters`)
...
- `docs/resvg-wrong/R2-filters.md`: one section per file with the above, then a
  summary table (file, class, correct reference, one-line cause), then a
  "Questions for Rowan" list.
- `docs/resvg-wrong/R2-filters.png`: one comparison sheet, a row per file:
...
|---|---|---|
| `filters/feFlood/complex-transform.svg` | pass 1.000000 | chrome=1 firefox=1 safari=1 |
| `filters/feFlood/partial-subregion.svg` | pass 1.000000 | chrome=1 firefox=1 safari=1 |
| `filters/feGaussianBlur/complex-transform.svg` | pass 1.000000 | chrome=1 firefox=1 safari=1 |
| `filters/feImage/link-on-an-element-with-complex-transform.svg` | pass 1.000000 | chrome=1 firefox=2 safari=2 |
| `filters/feImage/with-subregion-5.svg` | fail 0.840000 | chrome=1 firefox=1 safari=1 |
| `filters/feMerge/complex-transform.svg` | pass 0.999625 | chrome=1 firefox=1 safari=1 |
| `filters/feOffset/complex-transform.svg` | pass 0.999700 | chrome=1 firefox=1 safari=1 |
| `filters/feOffset/fractional-offset.svg` | pass 1.000000 | chrome=1 firefox=2 safari=2 |
| `filters/feTurbulence/complex-transform.svg` | pass 0.998900 | chrome=1 firefox=1 safari=1 |
| `filters/filter/in=BackgroundAlpha-with-enable-background.svg` | pass 1.000000 | chrome=2 firefox=2 safari=2 |
| `filters/filter/in=BackgroundAlpha.svg` | pass 1.000000 | chrome=2 firefox=2 safari=2 |
| `filters/filter/in=BackgroundImage-with-enable-background.svg` | pass 1.000000 | chrome=2 firefox=2 safari=2 |
| `filters/filter/on-a-thin-rect.svg` | pass 1.000000 | chrome=1 firefox=1 safari=1 |
| `filters/filter/subregion-and-primitiveUnits=objectBoundingBox-1.svg` | pass 1.000000 | chrome=1 firefox=1 safari=1 |
| `filters/filter/subregion-and-primitiveUnits=objectBoundingBox-2.svg` | pass 1.000000 | chrome=1 firefox=1 safari=1 |
| `filters/filter/transform-on-shape-with-filter-region.svg` | pass 0.999275 | chrome=2 firefox=1 safari=1 |
