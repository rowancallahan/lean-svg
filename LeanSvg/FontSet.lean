...
def entries : Array Entry := #[
  ...
  ⟨"Amiri", Fonts.Amiri.bytes, Fonts.Amiri.coverage⟩,
  ⟨"Noto Sans Hebrew", Fonts.NotoSansHebrew.bytes, Fonts.NotoSansHebrew.coverage⟩,
  ⟨"Noto Sans Devanagari", Fonts.NotoSansDevanagari.bytes, Fonts.NotoSansDevanagari.coverage⟩
]
